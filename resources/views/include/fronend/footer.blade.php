            ...
            <div class="container">
                <div class="row g-md-4 g-4 justify-content-between">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".5s">
                        <div class="single-footer-widget">
                            <div class="widget-head">
                                <h4 class="white">Kontak</h4>
                            </div>
                            <ul class="list-area list-contact">
                                <li>
                                    <i class="fa-solid fa-location-dot"></i>
                                    <span class="lited">
                                        Jl. Situ Tarate, Cangkuang Kulon, Kec. Dayeuhkolot, Kabupaten Bandung, Jawa Barat 40265
                                    </span>
                                </li>
                                <li>
                                    <i class="far fa-envelope"></i>
                                    <a href="info@example.com" class="link">BimbelQu@gmail.com</a>
                                </li>
                                <li>
                                    <i class="fa-solid fa-phone"></i>
                                    <a href="#" class="link">081931253987</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".7s">
                        <div class="single-footer-widget single-footer-form">
                            <div class="widget-head">
                                <h4 class="white">Buletin kami</h4>
                            </div>
                            <p class="white ">
            ...
            <div class="container">
                <div
                    ...
                    <p class="wow fadeInLeft color-2" data-wow-delay=".3s">
                        &copy; BimbelQu 2024 | All Rights Reserved
                    </p>
